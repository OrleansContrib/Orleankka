...
namespace Orleankka
{
    ...
    public class StreamSubscription<TItem> : IEquatable<StreamSubscription<TItem>>
    {
        [Id(0)] readonly StreamSubscriptionHandle<TItem> handle;
